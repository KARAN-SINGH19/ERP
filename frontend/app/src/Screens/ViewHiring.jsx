...
const ViewHiring = () => {
    ...
    const fetchHirings = async () => {
        try {
            ...
            const response = await axios.get(`http://localhost:5000/api/v1/getHirings?${params}`, {
                headers: {
    ...
    const saveLocation = async (id, locationValue) => {
        try {
            const response = await axios.put(`http://localhost:5000/api/v1/updateLocation/${id}`, { location: locationValue });
            if (response.data.success) {
                Swal.fire({
                    title: "Updated!",
    ...
    const deleteHiring = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                const response = await axios.delete(`http://localhost:5000/api/v1/deleteHiring/${id}`);
                if (response.data.success) {
                    Swal.fire({
                        title: "Deleted!",
    ...
    const saveRemark = async (id, remarkValue) => {
        try {
            const response = await axios.put(`http://localhost:5000/api/v1/updateRemark/${id}`, { remarks: remarkValue });
            if (response.data.success) {
                Swal.fire({
                    title: "Updated!",
    ...
    const saveComment = async (id, commentValue) => {
        try {
            const response = await axios.put(`http://localhost:5000/api/v1/updateComment/${id}`, { comment: commentValue });
            if (response.data.success) {
                Swal.fire({
                    title: "Updated!",
