...
const AddHiring = () => {
    ...
    useEffect(() => {
        const fetchClients = async () => {
            try {
                const response = await axios.get('http://localhost:6000/api/v1/getClientNames');
    ...
    useEffect(() => {
        const fetchPositions = async () => {
            try {
                if (selectedClient) {
                    const response = await axios.get(`http://localhost:6000/api/v1/fetchPositions/${selectedClient}`);
                    if (response.data.success) {
    ...
    useEffect(() => {
        const fetchCandidates = async () => {
            try {
                const response = await axios.get('http://localhost:6000/api/v1/getCandidateNameOrg');
                if (response.data.success) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:6000/api/v1/addHiring', data, {
                headers: {
