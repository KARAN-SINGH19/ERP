...
const UpdatePosition = () => {
    ...
    async function fetchPosition() {
        try {
            const response = await axios.get(`http://localhost:5000/api/v1/getPosition/${id}`);
    ...
    const updatePosition = async () => {
        ...
        try {
            ...
            const response = await axios.put(`http://localhost:5000/api/v1/updatePosition/${id}`, data, {
                headers: {
